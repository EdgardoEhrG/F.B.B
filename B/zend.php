...
<link rel="shortcut icon" href="../Images/I/Z.png" type="image/x-icon">
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Программный каркас для создания Web-приложений</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://ru.wikipedia.org/wiki/Zend_Framework">* Zend</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://framework.zend.com/">* Zend Docs</a><br />
        </p>
      </div>
