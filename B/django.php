...
<link rel="shortcut icon" href="../Images/I/django.png" type="image/x-icon">
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Каркас для Web-приложений / сайтов</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://ru.wikipedia.org/wiki/Django">* Django</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://www.djangoproject.com/">* Django Docs</a><br />
        </p>
      </div>
