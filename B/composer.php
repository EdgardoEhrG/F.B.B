...
<link rel="shortcut icon" href="../Images/I/Composer.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand">Composer</a>
    </div>
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Пакетный менеджер для PHP</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://ru.wikipedia.org/wiki/Composer">* Composer</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://getcomposer.org/">* Composer Docs</a><br />
        </p>
      </div>
