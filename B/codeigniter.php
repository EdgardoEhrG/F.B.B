...
<link rel="shortcut icon" href="../Images/I/flame.png" type="image/x-icon">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://ru.wikipedia.org/wiki/CodeIgniter">* CodeIgniter</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://codeigniter.com/">* CodeIgniter Docs</a><br />
        </p>
      </div>
