...
<link rel="shortcut icon" href="../Images/I/Firebase.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand"><i class="fa fa-database colored" aria-hidden="true"></i> Firebase</a>
    </div>
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Cloud Database</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://en.wikipedia.org/wiki/Firebase">* Firebase</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://firebase.google.com/">* Firebase Docs</a><br />
        </p>
      </div>
