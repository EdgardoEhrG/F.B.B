...
<link rel="shortcut icon" href="../Images/I/Dru.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand"><i class="fa fa-drupal colored" aria-hidden="true"></i> Drupal</a>
    </div>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
          <p>
            ...
            <a href="https://ru.wikipedia.org/wiki/Drupal">* Drupal</a><br />
            <br />

            <span class="v"><strong># Документация</strong></span><br />
            <a href="https://www.drupal.org/">* Drupal Docs</a><br />
          </p>
