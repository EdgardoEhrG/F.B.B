...
<link rel="shortcut icon" href="../Images/I/Jo.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand"><i class="fa fa-joomla colored" aria-hidden="true"></i> Joomla</a>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://ru.wikipedia.org/wiki/Joomla!">* Joomla</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://www.joomla.org/">* Joomla Docs</a><br />
        </p>
      </div>
