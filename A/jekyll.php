...
<link rel="shortcut icon" href="../Images/I/Je.png" type="image/x-icon">
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Генератор статических сайтов</h3>
  </div>
        ...
        <h4 class="modal-title" id="myModalLabel">Справка</h4>
          ...
          <div class="modal-body">
            <p>
              ...
              <a href="https://en.wikipedia.org/wiki/Jekyll_(software)">* Jekyll</a><br />
              <br />

              <span class="v"><strong># Документация</strong></span><br />
              <a href="https://jekyllrb.com/">* Jekyll Docs</a><br />
            </p>
        ...
        <h4 class="modal-title" id="myModalLabel">Заметки</h4>
          ...
          <div class="modal-body">
            <p class="textblock">
              ...
              - Берет исходные файлы и создает сайт из статичных страниц, готовых обслуживать пользователя напрямую.<br />
            </p>
          </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Закрыть</button>
