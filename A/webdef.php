...
<title>Web Defence</title>

<link rel="shortcut icon" href="../Images/I/sh.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand"><i class="fa fa-shield colored" aria-hidden="true"></i> Web Defence</a>
  </div>
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Информационная безопасность</h3>
  </div>
