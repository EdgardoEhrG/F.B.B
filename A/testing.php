...
<link rel="shortcut icon" href="../Images/I/tools.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand"><i class="fa fa-bug colored" aria-hidden="true"></i> Testing & Debugging</a>
  </div>
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Тестирование ПО</h3>
  </div>
