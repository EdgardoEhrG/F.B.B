        ...
        <h4 class="modal-title" id="myModalLabel">Заметки</h4>
          ...
          <div class="modal-body">
            <p class="textblock">
              ...
              - Хорошо совместим с React.<br />
              - Использует JSDOM - библиотека имитирующая браузер, но без разметки и навигации. Имитирует действия пользователя.<br />
              <br />
            </p>
          </div>
        <div class="modal-footer">
...
<button class="button5" id="NachB">Начало работы с Jest</button>
