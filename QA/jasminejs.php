...
<link rel="shortcut icon" href="../Images/I/Jasmine.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand">JasmineJS</a>
    </div>
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Тестирование JS</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://en.wikipedia.org/wiki/Jasmine_(JavaScript_testing_framework)">* JasmineJS</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://jasmine.github.io/">* JasmineJS Docs</a>
        </p>
      </div>
