...
<link rel="shortcut icon" href="../Images/I/Karma.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand">KarmaJS</a>
    </div>
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Запуск тестов для JS</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://habr.com/company/rambler-co/blog/278503/">* KarmaJS</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://karma-runner.github.io/2.0/index.html">* KarmaJS Docs</a>
        </p>
      </div>
