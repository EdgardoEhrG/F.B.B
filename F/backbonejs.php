...
<link rel="shortcut icon" href="../Images/I/Back.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand">BackboneJS</a>
    </div>
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Разработка Web-приложений с поддержкой RESTful JSON интерфейса</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://ru.wikipedia.org/wiki/Backbone.js">* BackboneJS</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="http://backbonejs.org/">* BackboneJS Docs</a><br />
        </p>
      </div>
