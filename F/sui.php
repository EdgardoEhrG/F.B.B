...
<link rel="shortcut icon" href="../Images/I/sui.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand">Semantic UI</a>
    </div>
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">CSS-фреймворк для создания переносимых интерфейсов / аналог Bootstrap</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://habrahabr.ru/post/193744/">* Semantic UI</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="http://semantic-ui.com/introduction/getting-started.html">* Semantic UI Docs</a><br />
        </p>
      </div>
