...
<link rel="shortcut icon" href="../Images/I/comp.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand">Compass</a>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://habrahabr.ru/post/194242/">* Compass</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="http://compass-style.org/">* Compass Docs</a><br />
        </p>
      </div>
