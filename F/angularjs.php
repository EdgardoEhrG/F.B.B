...
<link rel="shortcut icon" href="../Images/I/angularjs.png" type="image/x-icon">
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Разработка одностраничных Web-приложений</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://ru.wikipedia.org/wiki/AngularJS">* AngularJS</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://angular.io/">* AngularJS Docs</a><br />
        </p>
      </div>
