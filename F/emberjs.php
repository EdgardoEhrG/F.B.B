...
<link rel="shortcut icon" href="../Images/I/Emb.png" type="image/x-icon">
  ...
  <div class="navbar-header">
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
      ...
      <span class="icon-bar"></span>
        ...
        <a class="navbar-brand">EmberJS</a>
    </div>
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Каркас для Web-приложений и библиотека функций</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://ru.wikipedia.org/wiki/Ember.js">* EmberJS</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://www.emberjs.com/">* EmberJS Docs</a><br />
        </p>
      </div>
