...
<link rel="shortcut icon" href="../Images/I/d3.png" type="image/x-icon">
...
<div class="panel panel-warning" id="DS">
  <div class="panel-heading">
    <h3 class="panel-title">Визуализация данных</h3>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <a href="https://en.wikipedia.org/wiki/D3.js">* D3JS</a><br />
          <br />

          <span class="v"><strong># Документация</strong></span><br />
          <a href="https://d3js.org/">* D3JS Docs</a><br />
        </p>
      </div>
